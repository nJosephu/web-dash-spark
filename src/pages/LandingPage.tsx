    ...
    <div className="min-h-screen flex flex-col">
      ...
      >
        ...
        <div className="flex items-center gap-2 md:gap-4">
          <Link to="/login">
            <Button variant="ghost" className="font-medium text-gray-700 transition-all hover:scale-105">
              Log In
            </Button>
          </Link>
      ...
      {/* Hero Section */}
      <section 
        className={`px-4 py-12 md:py-20 bg-gradient-to-b from-[#f1edff] to-[#e9e1ff] flex-1 flex flex-col items-center text-center transition-all duration-1000 ease-in-out ${isPageLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}
      >
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-lg md:text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Create bills, share them, and get a timely collection from your sponsors. Collection made simple!
          </p>
          <Link to="/role-selection">
            <Button 
              size="lg" 
        ...
        <div className="mt-12 md:mt-16 max-w-5xl mx-auto w-full shadow-2xl rounded-lg overflow-hidden transition-transform hover:scale-[1.01] duration-300">
          <img 
            src="/lovable-uploads/95984db6-9b31-4948-bec9-528be1a445f7.png" 
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
            ...
            <div className="flex flex-col items-center text-center transform transition-all duration-500 hover:scale-105">
              <div className="text-xl font-semibold text-[#6544E4] mb-3">01</div>
              <h3 className="text-xl font-bold mb-4">Create Your Bills</h3>
              <p className="text-gray-600">
                Add all your expenses from bills and purchases to one form for sending.
              </p>
            </div>
            
            {/* Step 2 */}
            <div className="flex flex-col items-center text-center transform transition-all duration-500 hover:scale-105">
              <div className="text-xl font-semibold text-[#6544E4] mb-3">02</div>
            ...
            {/* Step 3 */}
            <div className="flex flex-col items-center text-center transform transition-all duration-500 hover:scale-105">
              <div className="text-xl font-semibold text-[#6544E4] mb-3">03</div>
      ...
      >
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-2xl md:text-3xl font-bold mb-3">Ready to Simplify Your Bill Payments?</h2>
          <p className="text-gray-600 mb-8">
            Join the list of others that have simplified their collections with Urgent 2Kay
          </p>
          <Link to="/role-selection">
            <Button 
              size="lg" 
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center mb-8">
            ...
            <div className="flex flex-wrap justify-center gap-4 md:gap-8">
              <Button variant="ghost" className="text-white hover:text-white/80 hover:bg-white/10 transition-all">
                Home
              </Button>
              <Button variant="ghost" className="text-white hover:text-white/80 hover:bg-white/10 transition-all">
                Contact
